...
export default function DividendScheduleForm({ initialData = null, onSave }) {
    ...
    return (
        <form className="space-y-4 mb-6" onSubmit={handleSubmit}>
            <div className="text-lg font-semibold">{isEditing ? 'Edit Dividend Schedule' : 'Add Dividend Schedule'}</div>
            ...
            <div className="flex gap-4">
                <div className="flex-1">
                    <label className="block text-sm font-medium">Dividend per share</label>
                    <input
                        type="number"
                        step="0.01"
                        value={dividend}
            ...
            <div className="flex gap-4">
                <Button type="submit">{isEditing ? 'Update Schedule' : 'Save Schedule'}</Button>
                {isEditing && (
                    <button
                        type="button"
                        onClick={resetForm}
