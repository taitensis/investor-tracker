...
export default function DividendSummaryPanel() {
    ...
    useEffect(() => {
        ...
        `
            ...
            if (tradeErr) {
                toast.error(`Failed to load trades: ${tradeErr.message}`)
                return
            }
            ...
            const currentHoldings = Object.values(holdings).filter(
                (h) => h.shares > 0
            )
            ...
            const forecast = getForecastedDividends({
